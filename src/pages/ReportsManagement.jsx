  ...
  const fetchDataViaAPI = useCallback(async () => {
    try {
      ...
      const [summaryResponse, earningsResponse, driverResponse] = await Promise.all([
        fetch(`https://panalsbackend-production.up.railway.appapi/reports/summary?${params}`).catch((e) => {
          console.error("Summary API error:", e)
          return null
        }),
        fetch(`https://panalsbackend-production.up.railway.appapi/reports/earnings?${params}`).catch((e) => {
          console.error("Earnings API error:", e)
          return null
        }),
        fetch(`https://panalsbackend-production.up.railway.appapi/reports/driver-performance?${params}`).catch((e) => {
...
const handleTimeRangeChange = (range) => {
  ...
  return (
 <div className="p-4 md:p-6 bg-gray-5 dark:bg-gray- min-h-screen">
      <div className="max-w-7xl mx-auto">
        {/* Header Section - Updated with gradient */}
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">
              Reports & Analytics
            </h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Track your earnings and ride performance metrics
            </p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 mb-6 border border-gray-100 dark:border-gray-700">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1 bg-white dark:bg-gray-700">
                ...
                <DatePicker
                  ...
                  startDate={startDate}
                  endDate={endDate}
                  className="bg-transparent text-sm w-24 dark:text-white focus:outline-none"
                  dateFormat="MMM d"
                />
              ...
              <select
                ...
                className="border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1 bg-white dark:bg-gray-700 text-sm dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
          ...
          >
            Earnings
            {activeTab === "earnings" && (
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-indigo-600 dark:bg-indigo-400 rounded-full"></div>
            )}
          </button>
          <button
          ...
          {isInitialLoad && isLoading ? (
            ...
            <>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Avg. per Ride</p>
                    <p className="text-2xl font-bold text-gray-800 dark:text-white mt-1">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Cancellation Rate</p>
                    <p className="text-2xl font-bold text-gray-800 dark:text-white mt-1">
                      {summaryData.cancellationRate?.toFixed(1) || "0.0"}%
                    </p>
                  </div>
                  <div className="p-2 rounded-lg bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-300">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-center mb-5">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Earnings Overview</h2>
                    <div className="flex items-center space-x-2">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {/* Earnings vs Rides */}
                  <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-5">Earnings vs Rides</h2>
                    <div className="h-64">
                      {hasData ? (
                        <ResponsiveContainer width="100%" height="100%">
