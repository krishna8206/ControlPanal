...
const API_URL = process.env.REACT_APP_API_URL || "https://panalsbackend-production.up.railway.appapi"
...
export const dashboardAPI = {
  ...
  getRecentRides: (params) => api.get("/dashboard/trip-analytics", { params }),
}
